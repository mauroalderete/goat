...
func TestNewContext(t *testing.T) {
	...
	wd := os.Getenv("GOPATH") + "/src/github.com/mauroalderete/goat/test/context/TestNewContext001"
	os.Chdir(wd)
	...
	wd = os.Getenv("GOPATH") + "/src/github.com/mauroalderete/goat/test/context/TestNewContext002"
	os.Chdir(wd)
